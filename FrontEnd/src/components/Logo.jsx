...
const Logo = ({ w, h }) => {
  return (
    ...
    >
      <g transform="matrix(1,0,0,1,-1.2121212121212466,-0.19630883428703783)">
        <svg
          viewBox="0 0 396 247"
          data-background-color="#ece6d6"
        ...
        >
          <g
            id="tight-bounds"
            transform="matrix(1,0,0,1,0.2400000000000091,0.03888394712822674)"
          >
            <svg
              viewBox="0 0 395.52 246.92223210574355"
              height="246.92223210574355"
              width="395.52"
            >
              <g>
                <svg
                  viewBox="0 0 397.4975999999999 248.15684326627223"
                  height="246.92223210574355"
                  width="395.52"
                >
                  <g>
                    <rect
                      ...
                      rx="1%"
                      id="yte-0"
                      data-palette-color="#b2572b"
                    ></rect>
                  </g>
                  <g transform="matrix(1,0,0,1,0.9887999999999693,155.7436108832104)">
                    <svg
                      viewBox="0 0 395.52 92.41323238306184"
                      height="92.41323238306184"
                      width="395.52"
                    >
                  ...
                  <g transform="matrix(1,0,0,1,138.38573445910401,0)">
                    <svg
                      viewBox="0 0 120.72613108179186 127.71508715339147"
                      height="127.71508715339147"
                      width="120.72613108179186"
                    >
                      <g>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          ...
                          id="icon-0"
                        >
                          <g fill="#d6acae" data-fill-palette-color="accent">
                            <g fill="#d6acae" data-fill-palette-color="accent">
                              <g
                                fill="#d6acae"
                                data-fill-palette-color="accent"
                            ...
                            <g fill="#d6acae" data-fill-palette-color="accent">
                              ...
                              >
                                <path
                                  d="M144.5 233.8C162.3 249.5 180.1 265.3 198 281 204.1 286.4 213.1 287 219.2 281L265.3 235.8C289.8 211.8 314.3 187.8 338.7 163.8L355.5 147.3C361.3 141.6 361.2 131.8 355.5 126.1 349.7 120.3 340.1 120.4 334.3 126.1L288.2 171.3C263.7 195.3 239.2 219.3 214.8 243.3L198 259.8H219.2C201.4 244.1 183.6 228.3 165.7 212.6 159.6 207.2 150.5 206.6 144.5 212.6 139 218.1 138.4 228.4 144.5 233.8"
                                  fill="#000000"
                                  data-fill-palette-color="accent"
                                ></path>
                              </g>
                  ...
                  <g>
                    <rect
                      width="61.85261445910406"
                      height="4.494918583035613"
                      y="122.22016857035585"
                      x="259.1118655408959"
                      fill="#000000"
                      data-fill-palette-color="secondary"
                    ></rect>
